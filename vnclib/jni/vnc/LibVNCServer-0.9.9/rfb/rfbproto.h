...
#define rfbExecuteShell 0xF1
/* Get Logcat output*/
#define rfbLogcat 0xF2
...
typedef struct {
	...
	uint32_t length;
    /* followed by char text[length] */
}rfbExcuteShellCmdMsg;

#define sz_rfbExcuteShellCmdMsg (8)
/**
  *Logcat
  *
  */
...
typedef struct {
	...
	uint16_t pad;
	uint32_t length;
	/* followed by lotcat cmd char text[length] */
}rfbLogcatMsg;

#define sz_rfbLogcatMsg (8)
